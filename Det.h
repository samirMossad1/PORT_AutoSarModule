...
#if ((DET_AR_MAJOR_VERSION != STD_TYPES_AR_MAJOR_RELEASE_VERSION)\
 || (DET_AR_MINOR_VERSION != STD_TYPES_AR_MINOR_RELEASE_VERSION)\
 || (DET_AR_PATCH_VERSION != STD_TYPES_AR_PATCH_RELEASE_VERSION))
